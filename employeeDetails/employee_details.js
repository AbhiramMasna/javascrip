...
// Function to display all employees (new function)
function displayAllEmployees() {
    const allEmployeesDisplay = employees.map((employee, index) => `<p>${employee.id}: ${employee.name} - ${employee.department} - $${employee.salary}</p>`).join('');
...
// Function to display HR employees (modified function)
